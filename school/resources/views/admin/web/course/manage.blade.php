...
<div class="container">
    ...
    <button type="button" class="btn btn-warning mb-3" data-toggle="modal" data-target="#importScoreModal">
        Import điểm
    </button>
    ...
    <a href="{{ route('admin.course.reopenCourse', ['id' => $course->id]) }}" onclick="return confirm('Bạn chắc muốn mở lại khoá học chứ? Sau khi mở lại khoá học, giảng viên có thể cập nhật thông tin liên quan tới khoá học.')">
                                        ...
                                        @else
                                            ...
                                            <ul class="custom-ul">
                                                <li>
                                                    ...
                                                    <a href="" data-toggle="modal" data-target="#updateBonusModal_{{ $bonus->id }}">
                                                        {{ $bonus->grade }}
                                                    </a>
                                                    <!-- bonus modal -->
                                                    <!-- Modal -->
